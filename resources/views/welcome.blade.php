        ...
        <div class="page-content">
            <section id="projects" class="content-section">
                <div class="section-heading">
                    <h1>Pengaduan<br><em><b>Masyarakat</b></em></h1>
                    <p>Punya Masalah? Tapi, Tidak Punya Solusi?
                    <br>Jangan Khawatir, Kami Siap Memberi Tanggapan Yang Terbaik.</p>
                </div>
                <div class="section-content">
                    <div class="masonry">
                        <div class="row">
                            <div class="item">
                                <div class="col-md-7">
                                    <a data-lightbox="image"><img src="{{ asset('mockup/img/gambar1.jpg')}}" alt="image 1"></a>
                                </div>
                            </div>
                            <div class="item second-item">
                                <div class="col-md-3">
                                    <a data-lightbox="image"><img src="{{ asset('mockup/img/gambar2.png')}}" alt="image 2"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-3">
                                    <a data-lightbox="image"><img src="{{ asset('mockup/img/gambar3.jpg')}}" alt="image 5"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-3">
                                    <a data-lightbox="image"><img src="{{ asset('mockup/img/portfolio_3.jpg')}}" alt="image 5"></a>
                                </div>
                            </div>
                        </div>
                    </div>
